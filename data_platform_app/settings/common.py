"""
Django settings for data_platform_app project.
...
MIDDLEWARE = [
    ...
    "data_platform_app.middleware.AllowElbHealthcheckIpHostMiddleware",
...
WSGI_APPLICATION = "data_platform_app.wsgi.application"
...
DATABASES: dict = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "data_platform_app"),
